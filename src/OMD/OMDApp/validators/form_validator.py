...
class CampaignDateValidator:
    def __call__(self, field):
        if field >= date(2024, 1, 1):
            raise ValidationError(_(f"Este campo debe contener una fecha válida de este año"))

    def get_help_text(self):
        return _("Este campo debe contener una fecha válida de este año.")